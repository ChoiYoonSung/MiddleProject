	      ...
	      <div class="col-md-8">
	        ...
	        <div class="card mb-4">
	          ...
	          <div class="card-body col-12">
	          	<h2 class="card-title col-12">작성한 댓글 목록
	            &nbsp;&nbsp;&nbsp;&nbsp;
	          	...
	          	<table class="table col-12" id="#">
	          		<thead>
						<tr class="d-flex justify-content-start">
							...
							<th class="col-3">댓글 작성일</th> <!-- REPLY_DATE -->
						</tr>
					</thead>
					<tbody class="col-12">
	          			<% 
	          			...
	          			if(commentListSize > 0){
	          				for(int i = 0; i < commentListSize ; i++){
	          					String boardCodeTxt = "";
	    	          			String boardCodeFolder = "";
	          					String boardCode = commentList.get(i).getCode();
	          					if("DEV".equals(boardCode)){
	          						boardCodeTxt = "커뮤니티-개발";
	          						boardCodeFolder = "DEV";
	          					} else if("QNA".equals(boardCode)){
	          						boardCodeTxt = "문의";
	          						boardCodeFolder = "QNA";
	          					} else if("PARTY".equals(boardCode)){
	          						boardCodeTxt = "파티";
	          						boardCodeFolder = "PARTY";
	          					} else if("CLASS".equals(boardCode)){
	          						boardCodeTxt = "커뮤니티-소속";
	          						boardCodeFolder = "QNA";
	          					} else if("JOB".equals(boardCode)){
	          						boardCodeTxt = "커뮤니티-직업";
	          						boardCodeFolder = "JOB";
	          					} else if("SOCIAL".equals(boardCode)){
	          						boardCodeTxt = "커뮤니티-친목";
	          						boardCodeFolder = "SOCIAL";
	          					} else if("CLASS".equals(boardCode)){
	          						boardCodeTxt = "커뮤니티-친목";
	          						boardCodeFolder = "classBoard";
	          					}
	          						//QNA PARTH CLASS JOB SOCIAL
	          						System.out.println("■■■■■ boardCodeFolder : " + boardCodeFolder);
	          					%>
	          					<tr class="d-flex text-center col-12">
	          						<td class="p-2 col-1"> <%= (i+1) %> </td>
	          						<td class="p-2 col-3"> <a href="<%=request.getContextPath() %>/<%= boardCodeFolder %>/select.do?boardSeq=<%= commentList.get(i).getBoardSeq() %>"><%= boardCodeTxt %></a></td>
	          						<td class="p-2 col-5"> <%= commentList.get(i).getReplyContent() %></td>
	          						<td class="p-2 col-3"> <%= commentList.get(i).getReplyDate() %></td>
	          					</tr>
	          					<%
	          				}
	          			} else {
