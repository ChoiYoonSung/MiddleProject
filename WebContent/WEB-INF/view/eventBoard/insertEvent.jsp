	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="card mb-4">
					<div class="card-body">
						<h2 class="card-title">게시판 등록</h2>
						<table class="table" >
							<tbody>
								<tr class="d-flex text-left">
									<th class="col-1 ">제목</th>
									<th class="col-11 "><input type="text" name="baordTitle" class="form-control input-lg" placeholder="제목을 입력해주세요."></th>
								</tr>
								<tr class="d-flex text-left">
							...
							<textarea class="form-control" name="baordContent" rows="10" placeholder="내용을 입력하세요."></textarea>
					</div>
					<div class="card-footer d-flex justify-content-end">
						<button class="btn btn-lg btn-secondary" type="submit">입력하기</button>
						&nbsp;&nbsp;
						&nbsp;&nbsp;
